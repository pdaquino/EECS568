...
*/
    ...
    **/
    public static double[] matrixToQuat(double R[][])
    {
        ...
        double m0 = R[0][0], m1 = R[1][0], m2 = R[2][0], m3 = R[3][0];
        double m4 = R[0][1], m5 = R[1][1], m6 = R[2][1], m7 = R[3][1];
        double m8 = R[0][2], m9 = R[1][2], m10 = R[2][2], m11 = R[3][2];
        double m12 = R[0][3], m13 = R[1][3], m14 = R[2][3], m15 = R[3][3];
    ...
    public static double[] quatToAngleAxis(double q[])
    {
        ...
        aa[0] = mod2pi(2 * Math.atan2(mag, q[0]));
        if (mag != 0) {
            aa[1] = q[1] / mag;
            aa[2] = q[2] / mag;
            aa[3] = q[3] / mag;
    ...
    public static void main(String args[])
    {
        ...
        */
        ...
        for (int i = 0; true && i < 1000000; i++) {
            ...
            double q1[] = matrixToQuat(quatToMatrix(q));
