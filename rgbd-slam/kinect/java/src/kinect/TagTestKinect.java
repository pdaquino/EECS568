...
public class TagTestKinect implements ParameterListener
{
    ...
    public static void main(String args[])
    {
        ...
        TagTestKinect tt = new TagTestKinect(k, tf);
    }

    public TagTestKinect(Kinect k, TagFamily tf)
    {
        this.k = k;
        this.tf = tf;
        ...
        vl.cameraManager.fit2D(new double[] {0,0}, new double[] { Constants.WIDTH, Constants.HEIGHT}, true);
        ...
        public void run()
        {
            ...
            while (true) {
                ...
                for (TagDetection d : detections) {
                    ...
                    double tagsize_m = 0.131;
                    //double f = 485.6;
                    double f = (Constants.Frgbx + Constants.Frgby)/2.0;
